...
public class DaoFragment extends Fragment {
    ...
    private DaoViewModel mViewModel;
    ...
    void initViewModel(GeneratedViewModelFactory viewModelFactory) {
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(DaoViewModel.class);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dao_fragment, container, false);
        TextView textView = view.findViewById(R.id.dao_textView);
        textView.setText(mViewModel.getDatabaseDao().getName());
        return view;
    }
}
