...
public class RepositoryFragment extends Fragment {
    ...
    @Inject
    public void initViewModel(GeneratedViewModelFactory viewModelFactory) {
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(RepositoryViewModel.class);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView textView = view.findViewById(R.id.repository_textView);
        textView.setText(mViewModel.getRepository().getName());
        return view;
    }
}
